<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"  EnableEventValidation="false"CodeFile="option_query.aspx.cs" Inherits="option_query" Title="OPTION OIV" %>
                        ...
                        <table align="center" cellspacing="0" bordercolordark="#ffffff" cellpadding="2" width="100%"
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="left" style="height: 30px">
                                                <span id="Span1" style="font-size: 16pt; font-family: Century Gothic"><strong>查詢OPTION當日最大量與最大未平倉</strong></span></td>
                            ...
                            <tr style="font-size: 12pt">
                                ...
                                <td align="left" colspan="1" style="width: 327px; height: 22px; text-align: left"
                                    valign="top">
                                    <asp:TextBox ID="TextBox1" runat="server" Width="91px" OnTextChanged="TextBox1_TextChanged" ></asp:TextBox></td>
                            </tr>
                            <tr>
