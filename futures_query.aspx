<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="futures_query.aspx.cs" Inherits="fortures_query" Title="fortures_query" %>
                        ...
                        <table align="center" cellspacing="0" bordercolordark="#ffffff" cellpadding="2" width="100%"
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="left" style="height: 30px">
                                                <span id="Span1" style="font-size: 16pt; font-family: Century Gothic"><strong>查詢期貨紀錄</strong></span></td>
                            ...
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: center"
                                    ...
                                    OP</td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:Label ID="Label2" runat="server" Text="Label" Width="110px"></asp:Label></td>
                                <td class="pageTD" style="width: 10%; height: 22px; text-align: center">
                                    上下限</td>
                                <td align="left" colspan="1" style="width: 327px; height: 22px; text-align: left"
                                    valign="top">
