<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EMS_CALENDAR.aspx.cs" Inherits="EMS_EMS_CALENDAR" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>EMS_CALENDAR</title>
</head>
<body>
    <form id="form1" runat="server">
   <div style="text-align: center">
       <span style="color: #0000ff"><strong><span style="font-family: Century Gothic">EMS CALENDAR</span></strong>
       </span>
