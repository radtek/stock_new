<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="AddForum.aspx.cs" Inherits="AddForum" Title="AddForum" %>
                        ...
                        <table align="center" cellspacing="0" bordercolordark="#ffffff" cellpadding="2" width="100%"
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="left" style="height: 30px">
                                                <span id="Span1" style="font-size: 16pt; font-family: Century Gothic"><strong>新增留言板
                                                    紀錄</strong></span></td>
                            ...
                            <tr style="font-size: 12pt">
                                ...
                                <td style="height: 7px; text-align: left;" valign="top" colspan="3">
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" Width="515px"></asp:TextBox></td>
                            </tr>
                                        ...
                                        <tr>
                                            <td align='left' valign='top' style="width: 14px; height: 17px;">
                                                <asp:Button ID="ButtonAdd" runat="server" Style="font-size: 12px; font-family: Arial;
                                                    width: 100px;" Text="新增主題" OnClick="ButtonAdd_Click" />
                                            </td>
                                                  ...
                                                  <asp:GridView ID="GridView1" runat="server" Font-Names="Century Gothic" Font-Size="13pt"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="TOPIC_NAME">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="HyperLink1" NavigateUrl='<%#"http://vsoscar.no-ip.org:8080/Stock_new/stock_pic.aspx?topicid=" + DataBinder.Eval(Container.DataItem, "TOPIC_ID") %> '
